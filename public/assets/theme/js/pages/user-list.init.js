...
//     editlist = !1,
//     options = {
//         valueNames: ["id", "user_name", "email", "date", "phone", "status"],
//         page: perPage,
//         pagination: !0,
...
// }
// var count = 11;
// forms = document.querySelectorAll(".user-form"),
// statusVal =
...
//                             "" !== roleField.value &&
//                             editlist &&
//                             ((t = userList.get({ id: idField.value })),
...
//                                 userList.remove("id", t.outerHTML),
//                                     document
...
//                             ((editlist = !0),
//                             (idField.value = t),
//                             (userNameField.value = e._values.user_name),
//                             (emailField.value = e._values.email),
//                             (roleField.value = e._values.phone),
//                             roleVal && roleVal.destroy(),
//                             (roleVal = new Choices(roleField, {
//                                 searchEnabled: 1,
//                             })),
...
//     (userNameField.value = ""), (emailField.value = ""), (roleField.value = "");
// }
