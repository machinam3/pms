...
<head>
    ...
    <meta charset="utf-8" />
    <title>@yield('page-title') | VESTA - Property Management System</title>
...
<body>
    ...
    <div id="layout-wrapper">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('assets/theme/images/logo-sm.png') }}" alt=""
                                        height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/theme/images/logo-dark.png') }}" alt=""
                                        height="17">
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/theme/images/logo-light.png') }}" alt=""
                                        height="17">
                                </span>
                            </a>
                        </div>
                            ...
                            <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ asset('assets/theme/images/users/avatar-1.jpg') }}"
                                        alt="Header Avatar">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/theme/images/logo-sm.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/theme/images/logo-dark.png') }}" alt="" height="17">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('assets/theme/images/logo-light.png') }}" alt="" height="17">
                    </span>
                </a>
    ...
    <!-- JAVASCRIPT -->
    <script src="{{ asset('assets/theme/libs/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('assets/theme/libs/simplebar/simplebar.min.js') }}"></script>
    <script src="{{ asset('assets/theme/libs/node-waves/waves.min.js') }}"></script>
    <script src="{{ asset('assets/theme/libs/feather-icons/feather.min.js') }}"></script>
